...
export class Footer extends Component {
    render() {
        return (
            <div>
                <footer class="page-footer font-large teal pt-5">
                    <div class="container-fluid text-justify bg-secondary p-4 m-4">
                        <div class="row">
                            <div class="col-md-4 mt-md-0 mt-3">
                                <h5 class="text-uppercase font-weight-bold">QUICK LINKS</h5>
                                <ul class="list-unstyled font-weight-bold">
                                    <li>
                                        <a href="#!" class="nav-link text-white">Applications Downloads</a>
                                    </li>
                                    <li>
                                        <a href="#!" class="nav-link text-white">Tariff</a>
                                    </li>
                                    <li>
                                        <a href="#!" class="nav-link text-white">Exchange Rate</a>
                                    </li>
                                    <li>
                                        <a href="#!" class="nav-link text-white">Sitemap</a>
                                    </li>
                                    <li>
                                        <a href="#!" class="nav-link text-white">Annual Report</a>
                                    </li>
                                </ul>
                            </div>
                            <hr class="clearfix w-100 d-md-none pb-3" />
                            <div class="col-md-4 mt-md-0 mt-3">
                                <h5 class="text-uppercase font-weight-bold">FollowUs</h5>
                            ...
                            <div class="col-md-4 mt-md-0 mt-3">
                                <h5 class="text-uppercase font-weight-bold">Reach Us</h5>
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="#!" class="nav-link text-white">Contact Us</a>
                                    </li>
                                    <li>
                                        <a href="#!" class="nav-link text-white">Branch Network</a>
                                    </li>
                                    <li>
                                        <a href="#!" class="nav-link text-white">Self Banking</a>
                                    </li>
